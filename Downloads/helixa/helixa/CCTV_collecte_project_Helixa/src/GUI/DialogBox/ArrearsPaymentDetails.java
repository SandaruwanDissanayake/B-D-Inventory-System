 ...
 * @author Mr. SP
 */
public class ArrearsPaymentDetails extends javax.swing.JDialog {
     ...
     */
    public ArrearsPaymentDetails(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public ArrearsPaymentDetails(Dashboard parent, boolean modal) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Arrears Payment Details");
        ...
        jPanel5.setPreferredSize(new java.awt.Dimension(861, 18));
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "#", "Invoice Number", "Date", "Total Amount", "Paid Amount", "Arrears Amount", "Payment Plan", "Customer"
            }
        ) {
    ...
    private void jTable2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable2MouseClicked
        if (evt.getClickCount() == 2) {
            ...
            new DetailsOfArrearsInvoice(this , true,invoiceId).setVisible(true);
        }
...
//            Logger.getLogger(ArrearsPaymentDetails.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ArrearsPaymentDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ArrearsPaymentDetails dialog = new ArrearsPaymentDetails(new javax.swing.JFrame(), true);
